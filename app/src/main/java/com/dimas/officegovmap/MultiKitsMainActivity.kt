...
package com.dimas.officegovmap
...
class MultiKitsMainActivity : AppCompatActivity() {
    ...
    private fun clickEvents() {
        mBtJava.setOnClickListener {
            startActivity(Intent(this, com.dimas.officegovmap.java.activity.MainActivity::class.java))
        }
        mBtKotlin.setOnClickListener {
            startActivity(Intent(this, com.dimas.officegovmap.kotlin.activity.MainActivity::class.java))
        }
    }
